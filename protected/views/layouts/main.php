...
<body class="thrColElsHdr" onload="javascript:controlInterfaz();" onresize="javascript:controlInterfaz();">
...
<div id="container">
  ...
  <tr>
    ...
    <td width="24%" id="encab">
      <h6 style="padding:0 0; margin:0 0;">Profesional: <?php echo $_SESSION["acxmph"]; ?></h6>
    </td>
  </tr>
</table>
</h1>
  ...
  <?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				array('label'=>'Inicio de sesión', 'url'=>array('index'),
				'items'=>array(
					array('label'=>'sub1', 'url'=>array('/site/index')),
					array('label'=>'sub2', 'url'=>array('/site/index'),
					'items'=>array(
						array('label'=>'sub1', 'url'=>array('/site/index')),
						array('label'=>'sub2', 'url'=>array('/site/index'))
					))
...
<div id="alertAdol" style="width:auto; height:300px; position:absolute; left:auto; top:auto; border:1px solid #003; display:none; background:#FFF; z-index:110; overflow-y:scroll">
   		<div style="color:#360"><div style="float:left; width:95%;" align="center"><h4 style="margin:0px 0px; padding:2px 0px;">Alertas</h4></div><div id="boton"><img src="imagenes/minusRedBut.ico" style=" width:20px; height:20px; cursor:pointer;" align="right" /></div></div><br /><br />
...
<!-- Alertas de tiempo de atención del adolescente-->   
   <div id="divAlertAtencion" style="width:auto; height:300px; position:absolute; left:auto; top:auto; border:1px solid #003; display:none; background:#FFF; z-index:110; overflow-y:scroll">
   		<div style="color:#360"><div style="float:left; width:95%;" align="center"><h4 style="margin:0px 0px; padding:2px 0px;">Estado de la atenci&oacute;n</h4></div><div id="boton"><img src="imagenes/minusRedBut.ico" style=" width:20px; height:20px; cursor:pointer;" align="right" /></div></div><br /><br />
 ...
 <!-- Alerta de permanencia del adolescente en el prograja-->  
      <div id="divAlertPermanencia" style="width:auto; height:300px; position:absolute; left:auto; top:auto; border:1px solid #003; display:none; background:#FFF; z-index:110; overflow-y:scroll">
   		<div style="color:#360"><div style="float:left; width:95%;" align="center"><h4 style="margin:0px 0px; padding:2px 0px;">Estado de permanencia</h4></div><div id="boton"><img src="imagenes/minusRedBut.ico" style=" width:20px; height:20px; cursor:pointer;" align="right" /></div></div><br /><br />
...
<!-- alertas de gestión de referenciación-->
      <div id="divAlertReferenciacion" style="width:auto; height:300px; position:absolute; left:auto; top:auto; border:1px solid #003; display:none; background:#FFF; z-index:110; overflow-y:scroll">
   		<div style="color:#360">
        <div style="float:left; width:95%;" align="center"><h4 style="margin:0px 0px; padding:2px 0px;">Tiempo de demora en la gesti&oacute;n</h4></div><div id="boton"><img src="imagenes/minusRedBut.ico" style=" width:20px; height:20px; cursor:pointer;" align="right" /></div></div><br /><br />
 ...
 <div id="sidebar2">
  ...
  <tr>
    <td  align="center"><img src="imagenes/cargando.gif" /></td>
  </tr>
</table>
</div>
   ...
   <div id="footer">
    <table width="100%" border="0">
    	<tr>
            ...
            <td id="pie" width="10%"><div id="reloj"></div><script>muestraReloj();</script></td>
	</tr>
</table>
  <!-- end #footer --></div>
<!-- end #container --></div>
